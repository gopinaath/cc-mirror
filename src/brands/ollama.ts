...
const theme: Theme = {
  ...
  colors: {
    ...
    bashBorder: rgb(palette.ember),
    claude: rgb(palette.emberDeep),
    claudeShimmer: lighten(palette.ember, 0.35),
    claudeBlue_FOR_SYSTEM_SPINNER: rgb(palette.ember),
    claudeBlueShimmer_FOR_SYSTEM_SPINNER: lighten(palette.emberBright, 0.2),
    permission: rgb(palette.clay),
    permissionShimmer: lighten(palette.clay, 0.25),
    planMode: rgb(palette.emberDeep),
    ide: rgb(palette.emberBright),
    ...
    subtle: mix(palette.base, palette.emberBright, 0.12),
    suggestion: rgb(palette.emberBright),
    remember: rgb(palette.emberDeep),
    ...
    purple_FOR_SUBAGENTS_ONLY: rgb(palette.ember),
    orange_FOR_SUBAGENTS_ONLY: rgb(palette.orange),
    pink_FOR_SUBAGENTS_ONLY: lighten(palette.clay, 0.32),
    cyan_FOR_SUBAGENTS_ONLY: rgb(palette.emberBright),
    professionalBlue: rgb(palette.ember),
    ...
    rainbow_blue: rgb(palette.emberBright),
    rainbow_indigo: rgb(palette.emberDeep),
    rainbow_violet: rgb(palette.ember),
    ...
    rainbow_blue_shimmer: lighten(palette.emberBright, 0.35),
    rainbow_indigo_shimmer: lighten(palette.emberDeep, 0.35),
    rainbow_violet_shimmer: lighten(palette.ember, 0.35),
    clawd_body: rgb(palette.emberDeep),
    clawd_background: rgb(palette.base),
    userMessageBackground: rgb(palette.panel),
    bashMessageBackgroundColor: rgb(palette.surface),
    memoryBackgroundColor: mix(palette.panel, palette.emberBright, 0.12),
    rate_limit_fill: rgb(palette.ember),
